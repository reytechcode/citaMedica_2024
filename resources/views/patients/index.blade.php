                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <button type="submit" onclick="deleteItem({{$paciente->id}})" class="btn btn-sm btn-danger">Eliminar</button>

                                
                                <form id="{{$paciente->id}}" action="{{ url('/pacientes/'.$paciente->id) }}" method="POST">
                                    @csrf 
                                    @method('DELETE') 
                                </form>
